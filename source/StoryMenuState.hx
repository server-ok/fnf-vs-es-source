...
class StoryMenuState extends MusicBeatState
{
	...
	static function weekData():Array<Dynamic>
	{
		return [
			['Tutorial'],
			['Lets be friends', 'I dont blame you', "Meet me there"],
			['Awakening power', "Thats our madhouse", "Glimmering coals"],
			['Everlasting Summer', 'Orchid', 'Four hundred and ten']
		];
	}
	...
	var perekritie:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('sovenokblur30'));
	...
	override function create()
	{
		...
		var yellowBG:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('storymenubg'));
