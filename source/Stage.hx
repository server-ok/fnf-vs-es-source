				...
				case "1lena":
					{
						camZoom = 0.9;
						curStage = '1lena';
						var bg:FlxSprite = new FlxSprite(-600, -500).loadGraphic(Paths.image('1lena'));
				...
				case "2lena":
					{
						camZoom = 0.9;
						curStage = '2lena';
						var bg:FlxSprite = new FlxSprite(-600, -500).loadGraphic(Paths.image('2lena'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						swagBacks['bg'] = bg;
				...
				case "3lena":
					{
						camZoom = 0.9;
						curStage = '3lena';
						var bg:FlxSprite = new FlxSprite(-600, -500).loadGraphic(Paths.image('3lena'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						swagBacks['bg'] = bg;
				...
				case "1alisa":
					{
						camZoom = 0.9;
						curStage = '1alisa';
						var bg:FlxSprite = new FlxSprite(-600, -500).loadGraphic(Paths.image('1alisa'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						swagBacks['bg'] = bg;
				...
				case "2alisa":
					{
						camZoom = 0.9;
						curStage = '2alisa';
						var bg:FlxSprite = new FlxSprite(-600, -500).loadGraphic(Paths.image('2alisa'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						swagBacks['bg'] = bg;
				...
				case "3alisa":
					{
						camZoom = 0.9;
						curStage = '3alisa';
						var bg:FlxSprite = new FlxSprite(-600, -500).loadGraphic(Paths.image('3alisa'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						swagBacks['bg'] = bg;
				...
				case "1pioneer":
					{
						camZoom = 0.9;
						curStage = '1pioneer';
						var bg:FlxSprite = new FlxSprite(-600, -500).loadGraphic(Paths.image('1pioneer'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						swagBacks['bg'] = bg;
				...
				case "2pioneer":
					{
						camZoom = 0.9;
						curStage = '2pioneer';
						var bg:FlxSprite = new FlxSprite(-600, -500).loadGraphic(Paths.image('2pioneer'));
						bg.antialiasing = FlxG.save.data.antialiasing;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						swagBacks['bg'] = bg;
