...
// (cool n swag) IMPORTS (by kade or ninjamuffin idk)
	...
	override public function create()
	{
		...
		if (isStoryMode)
		{
			switch (StringTools.replace(curSong, " ", "-").toLowerCase())
			{
				...
				case 'senpai' | 'lets-be-friends' | 'meet-me-there' | 'i-dont-blame-you' | 'awakening-power' | 'thats-our-madhouse' | 'glimmering-coals' | 'everlasting-summer' | 'orchid' | 'four-hundred-and-ten':
					schoolIntro(doof);
				case 'roses':
